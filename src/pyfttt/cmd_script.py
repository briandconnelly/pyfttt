...
def parse_arguments():
    ...
    sgroup.add_argument(
        "value1", nargs="?", help="Extra data sent with the event (optional)"
    )
    sgroup.add_argument(
        "value2", nargs="?", help="Extra data sent with the event (optional)"
    )
    sgroup.add_argument(
        "value3", nargs="?", help="Extra data sent with the event (optional)"
    )
